  ...
  return (
    <div className="navbar">
        <div className="header">
            <img src="" alt="" />
            <Link  style={{textDecoration:"none"}} to={state?"/":"/signin"}><h1 >Instagram</h1></Link>
        </div>
       <div className="screens">
            <li>
           {localStorage.getItem("tok") && <input onClick={handleShow}  type="text" placeholder="search other users" />}
